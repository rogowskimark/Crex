...
Pod::Spec.new do |s|
  s.name             = 'Crex'
  s.version          = '0.1.0'
  s.summary          = 'Crex is an library for simple and type safe usage of Notification Center'
  s.description      = 'Crex is an library for simple and type safe usage of Notification Center. Posting extra information is so handy due to code completion.'
